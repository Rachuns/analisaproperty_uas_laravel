  ...
  <div class="container"> 
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="{{ route('beranda.index') }}" class="page-scroll">Beranda</a></li>
        <li><a href="{{ route('tentang.index') }}" class="page-scroll">Tentang Kita</a></li>
...
<div id="video">
  <div class="container">
    <div class="row">
      ...
      <source src="/video/rumah.mp4" type="video/mp4"> </div>
    </div>
</div>
  ...
  <div class="container">
    ...
    <div class="col-md-3 col-md-offset-1 contact-info">
      <div class="contact-item">
        <h4>Info Kontak</h4>
        <p><span>Alamat</span>4321 California St,<br>
